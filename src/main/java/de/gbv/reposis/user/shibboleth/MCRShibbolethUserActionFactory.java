...
public class MCRShibbolethUserActionFactory {
    ...
    public static MCRShibbolethUserMapper getUserMapper() {
        return MCRConfiguration2.getSingleInstanceOfOrThrow(MCRShibbolethUserMapper.class, MCR_USER_MAPPER_CLASS);
    }

    public static MCRUserMerger getUserMerger() {
        return MCRConfiguration2.getSingleInstanceOfOrThrow(MCRUserMerger.class, MCR_USER_MERGER_CLASS);
    }

    public static MCRShibbolethNewUserHandler getNewUserHandler() {
        return MCRConfiguration2.getSingleInstanceOfOrThrow(MCRShibbolethNewUserHandler.class,
            MCR_USER_NEW_USER_HANDLER_CLASS);
    }
}
