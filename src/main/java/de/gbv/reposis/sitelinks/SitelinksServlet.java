...
public class SitelinksServlet extends MCRContentServlet {
    ...
    public void init() throws ServletException {
        super.init();
        try {
            this.service = MCRConfiguration2.getSingleInstanceOf(SitelinksService.class,PROP_PREFIX + "Service.Class")
                .orElseThrow(() -> new MCRConfigurationException("Missing SitelinksService configuration"));
            this.mapper = MCRConfiguration2.getSingleInstanceOf(SitelinksPageMapper.class, PROP_PREFIX + "Mapper.Class")
