...
<xsl:stylesheet version="3.0"
  ...
  <xsl:template match="mods:mods">
    ...
    <xsl:variable name="creator" select="
    ...
    <xsl:variable name="contributor" select="
      mods:name[mods:role/mods:roleTerm[@authority='marcrelator' and @type='code']/text()='ctb']
    " />
    ...
    <xsl:variable name="copyrightHolder" select="
      mods:name[mods:role/mods:roleTerm[@authority='marcrelator' and @type='code']/text()='cph']
    " />
    ...
    <xsl:variable name="publisher" select="
      mods:name[mods:role/mods:roleTerm[@authority='marcrelator' and @type='code']/text()='pbl']
    " />
    ...
    <xsl:variable name="provider" select="
      mods:name[mods:role/mods:roleTerm[@authority='marcrelator' and @type='code']/text()='prv']
    " />
    ...
    <xsl:variable name="maintainer" select="
      mods:name[mods:role/mods:roleTerm[@authority='marcrelator' and @type='code']/text()='led']
    " />
    ...
    <xsl:variable name="funder" select="
      mods:name[mods:role/mods:roleTerm[@authority='marcrelator' and @type='code']/text()='fnd']
    " />
    ...
    <xsl:variable name="sponsor" select="
      mods:name[mods:role/mods:roleTerm[@authority='marcrelator' and @type='code']/text()='spn']
    " />
    ...
    <xsl:if test="count(mods:relatedItem[@type='isReferencedBy']) &gt; 0">
      <fn:array key="referencePublication">
        <xsl:call-template name="parse-relatedItem">
          <xsl:with-param name="relatedItem" select="mods:relatedItem[@type='isReferencedBy']" />
        </xsl:call-template>
      </fn:array>
    </xsl:if>
    ...
    <!-- contIntegration -->
    <!-- issueTracker -->
    <xsl:copy-of select="mods:extension[@type='codemeta-part']/fn:map/*" copy-namespaces="no" />
  </xsl:template>
